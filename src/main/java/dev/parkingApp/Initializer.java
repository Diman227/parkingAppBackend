...
public class Initializer {
    ...
    public void initial() {
        ...
        spotService.addSpot(new SpotDTO(null, "Ул. Плехановская 12",
                "ул. Плехановская, д.12",
                new BigDecimal("4.2"),
                new BigDecimal(120),
                LocalDateTime.of(2025, 3, 15, 14, 20),
                new CoordinatesDTO(null, "39.2001", "51.6720"),
                2L, null));

        spotService.addSpot(new SpotDTO(null, "ТРК Арена",
                "ул. Кольцовская, д.35",
                new BigDecimal("4.5"),
                new BigDecimal(200),
                LocalDateTime.of(2025, 7, 10, 9, 45),
                new CoordinatesDTO(null, "39.2075", "51.6678"),
                3L, null));

        spotService.addSpot(new SpotDTO(null, "Парковка у театра",
                "пр. Революции, д.55",
                new BigDecimal("3.8"),
                new BigDecimal(100),
                LocalDateTime.of(2025, 4, 22, 16, 30),
                new CoordinatesDTO(null, "39.2043", "51.6602"),
                1L, null));

        spotService.addSpot(new SpotDTO(null, "Ж/д вокзал",
                "пл. Черняховского, д.1",
                new BigDecimal("4.0"),
                new BigDecimal(180),
                LocalDateTime.of(2025, 8, 5, 12, 15),
                new CoordinatesDTO(null, "39.2105", "51.6712"),
                4L, null));

        spotService.addSpot(new SpotDTO(null, "ТЦ Галерея Чижова",
                "Московский пр-т, д.129/1",
                new BigDecimal("4.7"),
                new BigDecimal(250),
                LocalDateTime.of(2025, 5, 30, 10, 0),
                new CoordinatesDTO(null, "39.2298", "51.6273"),
                2L, null));

        spotService.addSpot(new SpotDTO(null, "Ул. 20-летия Октября",
                "ул. 20-летия Октября, д.88",
                new BigDecimal("3.5"),
                new BigDecimal(90),
                LocalDateTime.of(2025, 11, 12, 13, 45),
                new CoordinatesDTO(null, "39.2320", "51.6415"),
                1L, null));

        spotService.addSpot(new SpotDTO(null, "БЦ на Лизюкова",
                "ул. Генерала Лизюкова, д.66",
                new BigDecimal("4.3"),
                new BigDecimal(170),
                LocalDateTime.of(2026, 1, 18, 8, 30),
                new CoordinatesDTO(null, "39.2247", "51.6332"),
                3L, null));

        spotService.addSpot(new SpotDTO(null, "Парковка у цирка",
                "ул. 20-летия ВЛКСМ, д.54",
                new BigDecimal("3.9"),
                new BigDecimal(110),
                LocalDateTime.of(2026, 2, 25, 15, 20),
                new CoordinatesDTO(null, "39.2391", "51.6468"),
                2L, null));

        spotService.addSpot(new SpotDTO(null, "ТЦ Московский",
                "Московский пр-т, д.201",
                new BigDecimal("4.6"),
                new BigDecimal(220),
                LocalDateTime.of(2025, 9, 14, 11, 10),
                new CoordinatesDTO(null, "39.2415", "51.6220"),
                4L, null));

        spotService.addSpot(new SpotDTO(null, "Университетская площадь",
                "Университетская пл., д.1",
                new BigDecimal("4.1"),
                new BigDecimal(130),
                LocalDateTime.of(2025, 12, 3, 14, 50),
                new CoordinatesDTO(null, "39.2138", "51.6660"),
                1L, null));

        spotService.addSpot(new SpotDTO(null, "Парковка на Ленинском",
                "Ленинский пр-т, д.77",
                new BigDecimal("3.7"),
                new BigDecimal(95),
                LocalDateTime.of(2026, 3, 8, 17, 25),
                new CoordinatesDTO(null, "39.2172", "51.6584"),
                3L, null));

        spotService.addSpot(new SpotDTO(null, "ТРК Сити-Парк",
                "ул. Парковая, д.3",
                new BigDecimal("4.8"),
                new BigDecimal(300),
                LocalDateTime.of(2025, 10, 29, 10, 45),
                new CoordinatesDTO(null, "39.1350", "51.6280"),
                2L, null));

        spotService.addSpot(new SpotDTO(null, "Ул. Домостроителей",
                "ул. Домостроителей, д.24",
                new BigDecimal("3.6"),
                new BigDecimal(85),
                LocalDateTime.of(2026, 4, 17, 12, 30),
                new CoordinatesDTO(null, "39.2463", "51.6382"),
                1L, null));

        spotService.addSpot(new SpotDTO(null, "БЦ на Кольцовской",
                "ул. Кольцовская, д.68",
                new BigDecimal("4.4"),
                new BigDecimal(190),
                LocalDateTime.of(2025, 6, 25, 9, 15),
                new CoordinatesDTO(null, "39.2090", "51.6651"),
                4L, null));

        spotService.addSpot(new SpotDTO(null, "Парковка у стадиона",
                "ул. Карла Маркса, д.67",
                new BigDecimal("4.0"),
                new BigDecimal(140),
                LocalDateTime.of(2026, 5, 22, 16, 40),
                new CoordinatesDTO(null, "39.2214", "51.6523"),
                2L, null));

        spotService.addSpot(new SpotDTO(null, "ТЦ Европа",
                "Ленинский пр-т, д.25",
                new BigDecimal("4.5"),
                new BigDecimal(210),
                LocalDateTime.of(2025, 8, 30, 13, 20),
                new CoordinatesDTO(null, "39.2067", "51.6645"),
                3L, null));

        spotService.addSpot(new SpotDTO(null, "Ул. Матросова",
                "ул. Матросова, д.15",
                new BigDecimal("3.8"),
                new BigDecimal(105),
                LocalDateTime.of(2025, 2, 14, 18, 10),
                new CoordinatesDTO(null, "39.1985", "51.6689"),
                1L, null));

        spotService.addSpot(new SpotDTO(null, "Парковка у реки",
                "наб. Адмиралатейская, д.12",
                new BigDecimal("4.2"),
                new BigDecimal(160),
                LocalDateTime.of(2026, 6, 10, 11, 55),
                new CoordinatesDTO(null, "39.2189", "51.6598"),
                4L, null));

        spotService.addSpot(new SpotDTO(null, "БЦ на Мира",
                "ул. Мира, д.43",
                new BigDecimal("4.3"),
                new BigDecimal(175),
                LocalDateTime.of(2025, 7, 28, 8, 45),
                new CoordinatesDTO(null, "39.2014", "51.6627"),
                2L, null));

        spotService.addSpot(new SpotDTO(null, "ТЦ на Плехановской",
                "ул. Плехановская, д.6",
                new BigDecimal("4.1"),
                new BigDecimal(145),
                LocalDateTime.of(2026, 7, 19, 14, 15),
                new CoordinatesDTO(null, "39.1968", "51.6732"),
                3L, null));
